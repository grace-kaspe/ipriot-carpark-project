...
|------------|---------------------------------------------------------------|--------------------------------|
| `CarPark`  | location ; plates ; capacity ; number_of_cars; available_bays | add_car ;  remove_car ;        |
| `Sensor`   | car_park;  id ;                                               | scan_plate ; update_car_park   | 
| `Display`  | message ;  weather ;                                          | display_message ; display_bays | 
...
![Added stubs for classes](screenshots/evidence-2.png)
...
> 
> CarPark, because CarPark holds the capacity attribute. It is also recording when car is coming in or out. </br>
> The number of available bays can easily be counted in the CarPark class

>Q. Which class is responsible for the current temperature (and why)?
> The car park. 
> Temperature is usually measured at certain locations. 
> The display is responsible of showing the data.

>Q. Which class is responsible for the time (and why)?
> The sensor. 
> The sensor is the first touch point when a car enters the car park.
> The sensor also is the last touch point when a car exits the car park.
--------
...
> In CarPark unit test Because the car park register method is under CarPark class.
...
> ![Added methods to the car park class](screenshots/8-after_updating_config.png)
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   > ![Main.py output](screenshots/9-main-py-result.png)
